...
def mgs():
    ...
    <html>
        ...
        <body>
            <h1 style="color: blue;">Welcome to our Mobile Money Service</h1>
            <h1 style="color: yellow;">Register Account</h1>
            ...
            <form action="register" method="post">
             ...
             <h1 style="color: yellow;">Perform Transactions</h1>
            <p style="color: green;">Use the Correct password to perform transactions and manage your account.</p>
        </body>
    </html>
    """
